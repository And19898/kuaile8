...
import com.mj.kuaile8.adapters.WeixinmeiwenAdapter;
import com.mj.kuaile8.adapters.XiaohuaAdapter;
import com.mj.kuaile8.databinding.LayoutListviewBinding;
import com.mj.kuaile8.models.WXMeiwen;
...
public class WXMeiwenActivity extends UIActivity<LayoutListviewBinding> implements BGARefreshLayout.BGARefreshLayoutDelegate,AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, BGAOnItemChildClickListener, BGAOnItemChildLongClickListener {
    private WeixinmeiwenAdapter mAdapter;
    private int page = 1;
...
//                Log.i(TAG, "正在滚动");
        ...
        mAdapter = new WeixinmeiwenAdapter(context);
        ...
        OkGo
                ...
                .execute(new StringCallback(){
                    ...
                    public void onSuccess(Response<String> response) {
                        WXMeiwen model = new Gson().fromJson(response.body(), new TypeToken<WXMeiwen>(){}.getType());
                        pageCount = model.getShowapi_res_body().getPagebean().getAllPages();
